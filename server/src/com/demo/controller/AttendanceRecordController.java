...
@CrossOrigin
public class AttendanceRecordController  extends Controller {
	
	public static final String DB_TABLE = "attendance_record";
	...
	static{
		...
		tableFilter.put("attendance_id","custom");
	...
	@CrossOrigin
	public void getAll(){
		List<AttendanceRecordModel> models = AttendanceRecordModel.dao.find("select * from "+DB_TABLE+" where del != 'delete'");
	...
	public void get(){
		...
		List<AttendanceRecordModel> models = AttendanceRecordModel.dao.find("select * from "+DB_TABLE+" where id = "+id+" and  del != 'delete'");
		JSONObject js = new JSONObject();
		if(models!=null&&models.size()>=1){
			js.put(Const.KEY_RES_CODE, Const.KEY_RES_CODE_200);
	...
	public void add(){
		JSONObject js = new JSONObject();
		try{
			AttendanceRecordModel model = getModel(AttendanceRecordModel.class, "", true);
