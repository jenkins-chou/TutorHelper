...
@CrossOrigin
public class ScientSubjectController  extends Controller {
	
	public static final String DB_TABLE = "scient_subject";
	...
	@CrossOrigin
	public void getAll(){
		List<ScientSubjectModel> models = ScientSubjectModel.dao.find("select * from "+DB_TABLE+" where del != 'delete'");
	...
	public void get(){
		...
		List<ScientSubjectModel> models = ScientSubjectModel.dao.find("select * from "+DB_TABLE+" where id = "+id+" and  del != 'delete'");
		JSONObject js = new JSONObject();
		if(models!=null&&models.size()>=1){
			js.put(Const.KEY_RES_CODE, Const.KEY_RES_CODE_200);
	...
	@CrossOrigin
	public void search(){
		String map = "scient_subject_name";
		String key = getPara("key");
		List<ScientSubjectModel> models = ScientSubjectModel.dao.find("select * from "+DB_TABLE+" where "+map+" like '%"+key+"%' and del != 'delete'");
		JSONObject js = new JSONObject();
		if(models!=null && models.size()>=1){
			js.put(Const.KEY_RES_CODE, Const.KEY_RES_CODE_200);
			js.put(Const.KEY_RES_DATA, models);
